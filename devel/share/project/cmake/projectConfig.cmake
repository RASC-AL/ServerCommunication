...
if("TRUE" STREQUAL "TRUE")
  set(project_SOURCE_PREFIX /home/sbrover/Rover2015/src/project/project)
  set(project_DEVEL_PREFIX /home/sbrover/Rover2015/devel)
  set(project_INSTALL_PREFIX "")
  set(project_PREFIX ${project_DEVEL_PREFIX})
else()
  set(project_SOURCE_PREFIX "")
  set(project_DEVEL_PREFIX "")
  set(project_INSTALL_PREFIX /home/sbrover/Rover2015/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'project' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'amit <amit@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'project' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sbrover/Rover2015/src/project/project/${idir}'.  Ask the maintainer 'amit <amit@todo.todo>' to fix it.")
    endif()
