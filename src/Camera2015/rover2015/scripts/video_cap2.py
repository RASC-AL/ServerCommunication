...
def getCommand():
    ...
    return['gst-launch', 'v4l2src', 'device=/dev/video' + str(cam), '!', 'video/x-raw-yuv,width=640,height=480', '!',  'x264enc', 'pass=qual', 'quantizer=20', 'tune=zerolatency', '!', 'rtph264pay', '!', 'udpsink', 'host=128.205.55.104', 'port=1234']
